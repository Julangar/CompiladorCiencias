...
/* Operador logico and */
( "&&" ) {return new Symbol(sym.Op_log_and, yychar, yyline, yytext()); } 

/* Operador logico or */
( "||" ) {return new Symbol(sym.Op_log_or, yychar, yyline, yytext()); } 

/* Operador logico not */
( "!" ) {return new Symbol(sym.Op_log_not, yychar, yyline, yytext()); } 

/* Operador logico and bit a bit */
( "&" ) {return new Symbol(sym.Op_log_and_bit, yychar, yyline, yytext()); } 

/* Operador logico or bit a bit */
( "|" ) {return new Symbol(sym.Op_log_or_bit, yychar, yyline, yytext()); }

/* Operador Relacional Mayor que */
( ">" ) {return new Symbol(sym.Op_rel_mayor_que, yychar, yyline, yytext());}

/* Operador Relacional Menor que */
( "<"  ) {return new Symbol(sym.Op_rel_menor_que, yychar, yyline, yytext());}

/* Operador Relacional Equivalente */
( "==" ) {return new Symbol(sym.Op_rel_equivalente, yychar, yyline, yytext());}
...
( "<<" ) {return new Symbol(sym.Op_rel_desplaz_izq, yychar, yyline, yytext());}

/* Operador Relacional Desplazamiento Derecha */
( ">>" ) {return new Symbol(sym.Op_rel_desplaz_der, yychar, yyline, yytext());}

/* Operador Atribucion Suma */
( "+=" ) {return new Symbol(sym.Op_atr_suma, yychar, yyline, yytext()); }

/* Operador Atribucion Resta */
( "-=" ) {return new Symbol(sym.Op_atr_resta, yychar, yyline, yytext()); }

/* Operador asignacion libreria */
( "#" ) {return new Symbol(sym.Op_inclu_lib, yychar, yyline, yytext());}

/* Operador Atribucion Producto */
( "*=") {return new Symbol(sym.Op_atr_producto, yychar, yyline, yytext()); }

/* Operador Atribucion Division */
( "/=" ) {return new Symbol(sym.Op_atr_division, yychar, yyline, yytext()); }

/* Operador Atribucion Modulo */
( "%=" ) {return new Symbol(sym.Op_atr_modulo, yychar, yyline, yytext()); }

/* Operador Incremento */
( "++" ) {return new Symbol(sym.Op_atr_incremento, yychar, yyline, yytext()); }

/* Operador Decremento */
( "--" ) {return new Symbol(sym.Op_atr_decremento, yychar, yyline, yytext()); }
